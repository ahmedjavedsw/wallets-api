...
class WalletUS_Portal
{
	...
	public function set_order($userEmail, $userName, $amount, $order_id, $unique_code, $redirect_paid, $redirect_canceled) {
		$this->args = [
			'action' => 'new',
            ...
            "customer" => [
                'user_name' => $userName, //[Your Customer Email] example@gmail.com
    ...
    public function generate_link() {
        ...
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, $this->gateway_url.'generate-order');
